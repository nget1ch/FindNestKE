...
paymentsRouter.post('/card/initiate', tenantMiddleware, paymentController.createStripeIntent);
paymentsRouter.post('/card/confirm', tenantMiddleware, paymentController.confirmStripePayment);
